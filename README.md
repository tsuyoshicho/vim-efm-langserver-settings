...
| [textlint](https://www.npmjs.com/package/textlint)                       | text, markdown, html, rst, asciidoc, review, help                            | lint, format | npm                  | user config needed                       | `.textlintrc` in the project root.                                                                                                                                                                                                                                                                                      |
