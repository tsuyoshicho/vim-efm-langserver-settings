...
| [rstcheck](https://github.com/myint/rstcheck)                            | rst                                                                          | lint               | pip                  | not need config / user config affected   | mypy.ini, `.rstcheck.cfg` in same or upper dire, `setup.cfg` in project root.<br/>`.rstcheck.ini` in `$HOME` directory.                                                                                                                                                                                                 |
